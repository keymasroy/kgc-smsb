      ...
      <UItem class="card is-sub" ratio="1">
        ...
        <UFieldSet class="is-large">
          ...
          <UFieldRow>
            ...
            <UField label="최소보유포인트" required>
              <WjInputNumber />
            </UField>
          </UFieldRow>
          <UFieldRow>
            <UField label="1회최소사용포인트" required>
              <WjInputNumber />
            </UField>
            <UField label="1회최대사용포인트" required>
              <WjInputNumber />
            </UField>
          </UFieldRow>
          <UFieldRow>
            <UField label="일최대사용건수" required>
              <WjInputNumber />
            </UField>
            <UField label="일최대사용포인트" required>
              <WjInputNumber />
            </UField>
          </UFieldRow>
          <UFieldRow>
            <UField label="월최대사용건수" required>
              <WjInputNumber />
            </UField>
            <UField label="월최대사용포인트">
              <WjInputNumber />
            </UField>
          </UFieldRow>
          <UFieldRow>
