    ...
    <div class="pt-[40px] px-[20px] pb-[20px]">
      <form>
        ...
        <ul class="pt-[20px] mb-[40px]">
          ...
          <li class="flex flex-col mb-[20px]">
            <label class="py-[9px] text-sm" for="gender">성별 <span class="text-[#F46144]">*</span></label>
          ...
          <li class="flex flex-col mb-[20px]">
            ...
            <div class="flex flex-col w-full gap-2">
              <div class="flex gap-2">
                ...
                <Button label="인증하기" size="large" severity="secondary" class="w-[120px] pa-0" @click="onClickCert()" />
              </div>
        ...
        <div class="flex gap-2">
          <Button class="flex-1" label="다음" size="large" @click="$router.push('/pubs/MS/MJ/UI_FU_0039_2')" />
        </div>
      </form>
    </div>
