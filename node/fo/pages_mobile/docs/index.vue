...
const pages = [
  ...
  // 회원가입
  { label: '회원가입' },
  { label: '일반회원', subLabel: '인증 선택', url: '/pubs/MS/MJ/UI_FU_0040'  },
  { label: '', subLabel: '온라인 신규회원 > 본인인증 (약관동의)', url: '/pubs/MS/MJ/UI_FU_0039'  },
  { label: '', subLabel: '온라인 신규회원 > 본인인증 (약관동의 팝업)', url: '/pubs/MS/MJ/UI_FU_0039', content: '통합회원약관 내용보기 클릭' },
  { label: '', subLabel: '온라인 신규회원 > 본인인증 (정보입력)', url: '/pubs/MS/MJ/UI_FU_0041'  },
  { label: '', subLabel: '온라인 신규회원 > 본인인증 (가입완료)', url: '/pubs/MS/MJ/UI_FU_0042'  },
