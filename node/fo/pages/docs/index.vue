...
const pages = [
  ...
  // 회원가입
  { label: '회원가입' },
  { label: '일반회원', subLabel: '카카오 간편가입', url: '/pubs/MS/MJ/UI_FU_0007'  },
  { label: '', subLabel: '카카오 간편가입 > 본인인증 (약관동의)', url: '/pubs/MS/MJ/UI_FU_0006'  },
  { label: '', subLabel: '카카오 간편가입 > 본인인증 (약관동의 팝업)', url: '/pubs/MS/MJ/UI_FU_0006', content: '통합회원약관 내용보기 클릭' },
  { label: '', subLabel: '카카오 간편가입 > 본인인증 (정보입력)', url: '/pubs/MS/MJ/UI_FU_0008'  },
  { label: '', subLabel: '카카오 간편가입 > 본인인증 (가입완료)', url: '/pubs/MS/MJ/UI_FU_0009'  },
